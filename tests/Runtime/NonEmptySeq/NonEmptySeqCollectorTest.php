...
final class NonEmptySeqCollectorTest extends TestCase
{
    ...
    {
        $this->assertEquals([1, 2, 3], NonEmptyArrayList::collect([1, 2, 3])->getUnsafe()->toNonEmptyList());
        $this->assertEquals([1, 2, 3], NonEmptyLinkedList::collect([1, 2, 3])->getUnsafe()->toNonEmptyList());
    ...
    {
        $this->assertEquals([1, 2, 3], NonEmptyArrayList::collectUnsafe([1, 2, 3])->toNonEmptyList());
        $this->assertEquals([1, 2, 3], NonEmptyLinkedList::collectUnsafe([1, 2, 3])->toNonEmptyList());
    ...
    {
        $this->assertEquals([1, 2, 3], NonEmptyArrayList::collectNonEmpty([1, 2, 3])->toNonEmptyList());
        $this->assertEquals([1, 2, 3], NonEmptyLinkedList::collectNonEmpty([1, 2, 3])->toNonEmptyList());
    }
