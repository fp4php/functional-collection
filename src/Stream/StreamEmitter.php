...
interface StreamEmitter
{
     ...
     *
     * ```php
     * >>> Stream::emits([1, 2])->compile()->toList();
     * => [1, 2]
     * ```
     *
     * @template TValueIn
     ...
     *
     * ```php
     * >>> Stream::emits([1,2,3])->repeat()->take(8)->compile()->toList();
     * => [1, 2, 3, 1, 2, 3, 1, 2]
     * ```
     *
     ...
     *
     * ```php
     * >>> Stream::emit(1)->repeatN(3)->compile()->toList();
     * => [1, 1, 1]
     * ```
     *
     * @return Stream<TValue>
     ...
     *
     * ```php
     * >>> Stream::constant(0)->take(3)->compile()->toList();
     * => [0, 0, 0]
     * ```
     *
     * @template TValueIn
     ...
     *
     * ```php
     * >>> Stream::range(0, 10, 2)->compile()->toList();
     * => [0, 2, 4, 6, 8]
     * ```
     *
     ...
     *
     * ```php
     * >>> Stream::infinite()->map(fn() => rand(0, 1))->take(2)->compile()->toList();
     * => [0, 1]
     * ```
     *
     * @return Stream<Unit>
